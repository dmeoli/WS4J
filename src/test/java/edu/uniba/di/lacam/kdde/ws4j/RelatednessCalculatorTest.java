...
abstract public class RelatednessCalculatorTest {
	...
	protected List<Concept> n1Synsets =  db.getAllConcepts(n1, POS.n);
	protected List<Concept> n2Synsets = db.getAllConcepts(n2, POS.n);

	protected final String v1 = "migrate";
	protected final String v2 = "emigrate";
	protected final List<Concept> v1Synsets = db.getAllConcepts(v1, POS.v);
	protected final List<Concept> v2Synsets = db.getAllConcepts(v2, POS.v);
	
	protected final String a1 = "huge";
	protected final String a2 = "tremendous";
	protected final List<Concept> a1Synsets = db.getAllConcepts(a1, POS.a);
	protected final List<Concept> a2Synsets = db.getAllConcepts(a2, POS.a);
	
	protected final String r1 = "eventually";
	protected final String r2 = "finally";
	protected final List<Concept> r1Synsets = db.getAllConcepts(r1, POS.r);
	protected final List<Concept> r2Synsets = db.getAllConcepts(r2, POS.r);
	
	protected final String n3 = "manuscript";
	protected final String v3 = "write_down";
	protected final List<Concept> n3Synsets = db.getAllConcepts(n3, POS.n);
	protected final List<Concept> v3Synsets = db.getAllConcepts(v3, POS.v);
